...
OUTDIR=~/Chicken_Output/ANGSD_Out/filter_minMinor2_Melgal5
...
angsd -doHaploCall 2 -ref ${REFDIR}/${REFGENE} -bam ${FILES} -doCounts 1 -minMinor 2 -maxMis 0 -out ${OUTDIR} 
...
OUT=~/Chicken_Output/ANGSD_Out/filter_minMinor2_Melgal5.haplo.gz
echo "Found ${OUT}"
results=$?
if [ $results -ne 0 ]
then
